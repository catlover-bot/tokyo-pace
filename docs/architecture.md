...
`worker/gsiElevation.ts` ?ORS?????????????enrichment???3???25m?????????zoom 15?GSI?????????????????????????????????DEM5A?DEM5B?DEM10B???????????????????????????????????route API???????????

`src/domain/elevation.ts` ? raw sample ? duplicate??/resample ? 3???? ? 25m??grade ? slope class ? route metrics ???????????80%???unavailable?????`score`?????`slopeBurden`?`comparisonScore`?????????????????????????score?????????
